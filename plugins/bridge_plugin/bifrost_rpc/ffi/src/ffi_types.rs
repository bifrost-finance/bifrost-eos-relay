...
impl<'a> TryInto<Action> for &'a ActionFFI {
    type Error = Error;
...
impl<'a> TryInto<Vec<Checksum256>> for &'a Checksum256FFI {
    type Error = Error;
...
impl<'a> TryInto<ActionReceipt> for &'a ActionReceiptFFI {
    type Error = Error;
...
impl<'a> TryInto<IncrementalMerkle> for &'a IncrementalMerkleFFI {
    type Error = Error;
...
impl<'a> TryInto<Extension> for &'a ExtensionFFI {
    type Error = Error;
...
impl<'a> TryInto<Vec<Extension>> for &'a ExtensionsFFI {
    type Error = Error;
...
impl<'a> TryInto<ProducerKey> for &'a ProducerKeyFFI {
    type Error = Error;
...
impl<'a> TryInto<ProducerSchedule> for &'a ProducerScheduleFFI {
    type Error = Error;
...
impl<'a> TryInto<BlockHeader> for &'a BlockHeaderFFI {
    type Error = Error;
...
impl<'a> TryInto<SignedBlockHeader> for &'a SignedBlockHeaderFFI {
    type Error = Error;
